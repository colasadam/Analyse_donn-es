...
#Je propose de s??parer les donn??es en fonction de leurs cot?? de la courbe
...
# on obtient avec le test 2,177, or en lisant la table on observe qu'il faudrait etre ?? 2,145 donc on peut en conclure que l'inflation n'affecte pas la vie a Marseille 
...
# on obtient avec le test 2,321, or en lisant la table on observe qu'il faudrait etre ?? 2.048 donc on peut en conclure une ind??pendance entre Marseille et Aix
# on rejette le fait qu'il u est une d??pendance
...
# on obtient pour la forme 75.15 et pour la couleur 2.39, Or devrait trouver 7.81 ce qui montre que la couleur est plus importante pour trouver le melanome 
